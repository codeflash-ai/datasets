...
def _rel_to_abs_instr(rel_instr, name2len):
    ...
    """
    # Localize attributes to avoid repeated attribute access while preserving behavior.
    rounding = rel_instr.rounding
    pct_to_abs = _pct_to_abs_closest if rounding == "closest" else _pct_to_abs_pct1
